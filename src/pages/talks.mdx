...
- Burning Pen (Google internal conference)
...
I share what works, what doesn't, and the lessons learned along the way. Presentations include:
...
- **[Docs as Tests Book](/books/docs-as-tests)** - Deep dive into documentation testing strategies
